...
namespace sharpRPA.Core.AutomationCommands
{
    ...
    [XmlInclude(typeof(InputBoxCommand))]
    ...
    [XmlInclude(typeof(MessageBoxCommand))]
    [XmlInclude(typeof(MessageVariableCommand))]
    [Serializable]
    ...
    public class SeleniumBrowserElementActionCommand : ScriptCommand
    {
        ...
        public string v_InstanceName { get; set; }
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please select a message variable to modify")]
            ...
            if (sendingInstance.appInstances.TryGetValue(v_InstanceName, out browserObject))
            {
                ...
                switch (v_SeleniumElementAction)
                {
                    ...
                    case "Set Text":
                        ...
                        string textToSet = sendingInstance.objCreatevariableList.FirstOrDefault(x => x.VariableName == v_userVariableName).VariableValue; //(from rw in v_WebActionParameterTable.AsEnumerable()
    ...
    [Serializable]
    [Attributes.ClassAttributes.Group("InputBox Commands")]
    [Attributes.ClassAttributes.Description("This command allows you to show a MessageBox and get input.")]
    [Attributes.ClassAttributes.ImplementationDescription("This command implements 'MessageBox' and invokes VariableCommand to find variable data.")]
    public class InputBoxCommand : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please select a variable to modify")]
        public string v_userVariableName { get; set; }
        ...
        public string v_InputMessage { get; set; }




        public InputBoxCommand()
        {
            this.CommandName = "InputBoxCommand";
            this.SelectionName = "Show Input Box";
            this.CommandEnabled = true;
            // this.v_IBAutoCloseAfter = 0;
        ...
        public override void RunCommand(object sender)
        {
            ...
            if (requiredVariable != null)
            {
                requiredVariable.variableValue = v_InputMessage.ConvertToUserVariable(sender);
            }
            else
            {
                throw new Exception("Variable was not found. Enclose variables within brackets, ex. [vVariable]");
            ...
            // InputBox Commands -Show Input Box


            newCommandForm.defaultStartupCommand = "InputBox Commands - Show Input Box";
            //   newCommandForm.selectedCommand = Core.AutomationCommands.InputBoxCommand;
            ...
            if (newCommandForm.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                //add to listview
        ...
        public override string GetDisplayValue()
        {
            return base.GetDisplayValue() + " [Message: " + v_InputMessage + "]";
        }
    }
    ...
    public class HTTPQueryResultCommand : ScriptCommand
    {
        ...
        public HTTPQueryResultCommand()
        {
            ...
            this.CommandEnabled = true;
            //this.LineNumber = this.LineNumber.CompareTo("10");
            //RunCommand(this.LineNumber);  
    ...
    #region Akash
    [Serializable]
    [Attributes.ClassAttributes.Group("Akash")]
    [Attributes.ClassAttributes.Description("This command allows you to create a new Text Box Alert.")]
    [Attributes.ClassAttributes.ImplementationDescription("This command implements the 'TextBox' application object from SHDocVw.dll to achieve automation.")]

    public class MessageVariableCommand : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please select a message variable to modify")]
        public string v_userVariableName { get; set; }
        ...
        [Attributes.PropertyAttributes.PropertyUIHelper(Attributes.PropertyAttributes.PropertyUIHelper.UIAdditionalHelperType.ShowVariableHelper)]
        public string v_Input { get; set; }
        public MessageVariableCommand()
        {
            this.CommandName = "MessageVariableCommand";
            this.SelectionName = "Set Variable Message";
            this.CommandEnabled = true;
        }

        public override void RunCommand(object sender)
        {
            UI.CustomControls.frmAkash obj = new UI.CustomControls.frmAkash();
            obj.label1.Text = "Please Enter  "+v_userVariableName+"";
           // obj.textBox1.PasswordChar = ' ';
            obj.ShowDialog();
            var sendingInstance = (UI.Forms.frmScriptEngine)sender;
            var requiredVariable = sendingInstance.variableList.Where(var => var.variableName == v_userVariableName).FirstOrDefault();
            string strValue = obj.Data();
            //List<VariableList> objvalues = new List<VariableList>();
            VariableList objval = new VariableList();

            if (requiredVariable != null)
            {
                requiredVariable.variableValue = strValue; //v_Input.ConvertToUserVariable(sender);
                objval.VariableName = v_userVariableName;
                objval.VariableValue = strValue;
                //objvalues.Add(objval);
            }
            else
            {
                throw new Exception("Variable was not found. Enclose variables within brackets, ex. [vVariable]");
            }
            if (sendingInstance.objCreatevariableList !=null)
            {
                bool isFind = sendingInstance.objCreatevariableList.Exists(x => x.VariableName == v_userVariableName);
                if (isFind)
                {
                    sendingInstance.objCreatevariableList.Where(x => x.VariableName == v_userVariableName).First().VariableValue = strValue;
                }
                else
                {
                    sendingInstance.objCreatevariableList.Add(objval);
    ...
    public class PasswordMessageVariableCommand : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please select a message variable to modify")]
        public string v_userVariableName { get; set; }
        ...
        [Attributes.PropertyAttributes.PropertyUIHelper(Attributes.PropertyAttributes.PropertyUIHelper.UIAdditionalHelperType.ShowVariableHelper)]
        public string v_Input { get; set; }
        public PasswordMessageVariableCommand()
        {
            this.CommandName = "PasswordMessageVariableCommand";
            this.SelectionName = "Set Variable Message Password";
            this.CommandEnabled = true;
        }
        ...
        {
            UI.CustomControls.frmAkash obj = new UI.CustomControls.frmAkash();
            obj.label1.Text = "Please Enter Password";
            obj.textBox1.PasswordChar = '*';
            obj.ShowDialog();
            var sendingInstance = (UI.Forms.frmScriptEngine)sender;
            var requiredVariable = sendingInstance.variableList.Where(var => var.variableName == v_userVariableName).FirstOrDefault();
    ...
    [Attributes.ClassAttributes.Description("This command allows you to close a Selenium web browser session.")]
    [Attributes.ClassAttributes.ImplementationDescription("This command implements Selenium to achieve automation.")]
    public class SeleniumBrowserElementActionCommand1 : ScriptCommand
    {
        [XmlAttribute]
        [Attributes.PropertyAttributes.PropertyDescription("Please Enter the instance name")]
        public string v_InstanceName { get; set; }
        ...
        [Attributes.PropertyAttributes.PropertyDescription("Please select a message variable to modify")]
        public string v_userVariableName { get; set; }
        public SeleniumBrowserElementActionCommand1()
        {
            this.CommandName = "SeleniumBrowserCreateCommand1";
            this.SelectionName = "Element Action1";
            this.v_InstanceName = "default";
            this.CommandEnabled = true;
            ...
            if (sendingInstance.appInstances.TryGetValue(v_InstanceName, out browserObject))
            {
                ...
                switch (v_SeleniumElementAction)
                {
                    ...
                    case "Set Text":
                            ...
                            string textToSet = sendingInstance.objCreatevariableList.FirstOrDefault(x => x.VariableName == v_userVariableName).VariableValue;
