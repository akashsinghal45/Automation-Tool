...
namespace sharpRPA.UI.Forms
{
    public partial class frmScriptEngine : UIForm
    {
        ...
        // public List<Core.Script.ScriptVariable> CreatevariableList { get; set; }
        public List<Core.AutomationCommands.VariableList> objCreatevariableList = new List<Core.AutomationCommands.VariableList>();
